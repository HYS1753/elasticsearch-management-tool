  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] !max-w-[95vw] xl:!max-w-[1500px] overflow-hidden p-0">
        <div className="border-b bg-white dark:bg-slate-950 px-6 py-5">
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold text-slate-900 dark:text-slate-50">
              Query Explain Detail
            </DialogTitle>
            <DialogDescription className="mt-1 break-words text-sm text-slate-600 dark:text-slate-400">
        ...
        <ScrollArea className="h-[82vh]">
          {loading ? (
            <div className="flex h-[540px] items-center justify-center text-slate-500 dark:text-slate-400">
            ...
            <div className="space-y-6 p-6">
              <div className="grid gap-4 lg:grid-cols-4">
                <Card className="border-slate-200/70 shadow-sm">
                    ...
                    <div className="mt-2 break-all font-mono text-sm text-slate-900 dark:text-slate-50">
                        {data.id}
                    </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border-slate-200/70 shadow-sm">
                    ...
                    <div className="mt-2 break-words text-sm text-slate-900 dark:text-slate-50">
              ...
              {data.source && (
                <details className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
                  <summary className="cursor-pointer list-none px-5 py-4 font-semibold text-slate-900 dark:text-slate-50">
                    Source
                  </summary>
                  <div className="border-t p-4">
                    <pre className="overflow-x-auto rounded-xl bg-slate-50 dark:bg-slate-900 p-4 text-sm text-slate-700 dark:text-slate-300">
